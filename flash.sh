...
if [ "$WHICH" == "both" ];then
   ...
   esptool.py --port $PORT -b 115200 write_flash 0x00000 $BLANK 0x01000 $BLANK 0x40000 $BLANK 0x7c000 $BLANK 0x7e000 $BLANK 0x3D000 $BLANK 0x7c000 $DEFAULTBIN 0x40000 $ESPSDK 0x00000 $ATAPP 
