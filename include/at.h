...
typedef enum{
    MSG_MUX=0x0b,
    MSG_RESTART=0x0c,
    MSG_LINK_SET_FAIL=0x0d,
    MSG_IP_MODE=0x0e,
    MSG_TOO_LONG=0x0f,
    MSG_TYPE_ERROR=0x10,
    MSG_LINK_DONE=0x11,
    MSG_NO_CHANGE=0x12,
    MSG_TCP_SERVER_FAIL=0x13,
    MSG_FAIL=0x14,
    MSG_NOAP=0x15,
    MSG_CLIENT_CONNECTED=0x16,
    MSG_CLIENT_DISCONNECTED=0x17,
    MSG_SEND=0x18,
    MSG_CONNECT=0x19,
    MSG_CLOSED=0x1a,
    MSG_DNS_FAIL=0x1b,
    MSG_ID_ERROR=0x1c,
    MSG_LINK_TYPE_ERROR=0x1d,
    MSG_IP_ERROR=0x1e,
    MSG_ENTRY_ERROR=0x1f,
    MSG_MISS_PARAM=0x20,
    MSG_ALREADY_CONNECT=0x21,
    MSG_CONNECT_FAIL=0x22,
    MSG_FAIL_READ_FLASH=0x23,
    MSG_FAIL_WRITE_FLASH=0x24,
    MSG_FAIL_TCP_MAX_CONN=0x25,
    MSG_PARSE_FAIL=0x26,
    MSG_FAIL_SET_MODE=0x27,
    MSG_FAIL_DHCP=0x28,
    MSG_FAIL_SET_AP=0x29,
    MSG_FAIL_SET_MULT_CON=0x2a,
    MSG_INVALID_MODE=0x2b
